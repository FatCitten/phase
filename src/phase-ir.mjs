...
export function loadWorkflow(path) {
  const p = resolve(path); return normalizeWorkflow(JSON.parse(readFileSync(p,'utf8')), { baseDir: dirname(p) });
}
export function workflowHash(workflow) { return sha(workflow); }
